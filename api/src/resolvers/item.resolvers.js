...
export const Item = () => ({
  post_having_ability: resolve.entityMerge('Item', 'HAS', 'Ability', 'OUT', { instance: true }),
  ...
  post_having_objective: resolve.entityMerge('Item', 'HAS', 'Objective', 'OUT', { instance: true }),
  post_for_organization: resolve.entityMerge('Item', 'HAS', 'Organization', 'IN', { instance: true }),
